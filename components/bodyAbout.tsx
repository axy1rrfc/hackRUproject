...
const subjects = [
  {
    ...
    content:
      'Food allergies affect 32 million Americans, including 1 in 13 children. The most common allergens are milk, eggs, peanuts, tree nuts, soy, wheat, fish, shellfish, and sesame. 40% of children with food allergies have had severe reactions, with peanuts, tree nuts, milk, and eggs being the most common triggers of anaphylaxis. While some allergies, like milk and eggs, may be outgrown, peanut, tree nut, fish, and shellfish allergies are often lifelong. Food allergies are increasing globally, with varying prevalence based on region',
        ...
        <div className="flex flex-col items-center justify-center p-6">
          ...
          {selectedSubject && (
            <motion.div
              {...{
                className:
                  'mt-6 p-6  rounded-lg bg-yellow-500 w-full max-w-lg text-center',
              }}
            ...
            >
              ...
              <Image
                src={
                  subjects.find((s) => s.id === selectedSubject)?.imgSrc || ''
                }
                alt="Allergy Info"
                width={400}
                height={250}
