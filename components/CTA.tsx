  ...
  <SectionWrapper>
    ...
    <span className="text-green-700 font-extrabold">RU</span><span className="text-green-700">Allergic</span> is proudly open source, empowering users with accessible and transparent technology in order to figure out their <span className="text-green-700 font-extrabold">allergens</span>.
        ...
        <a
          ...
          className="mt-4 inline-flex justify-center items-center gap-2 font-medium text-sm text-green-700 bg-yellow-400 hover:bg-green-500 active:bg-yellow-500 max-w-[200px] py-2.5 px-4 text-center rounded-lg duration-150"
        >
          <svg
            aria-hidden="true"
            className="h-6 w-6 fill-green-700 group-hover:fill-green-700"
          >
...
const SectionWrapper = ({ children, ...props }: any) => (
  <section {...props} className={`py-5 ${props.className || ''}`}>
    {children}
  </section>
);
